<?php
	class Page {
		...
		//显示每页从第几条到第几条数据
		public function setLimit($offset = 0){
			$startPos	=	(($this->page-1)*$this->listRows)+$offset;
			return  "Limit ".$startPos.", {$this->listRows}";
		}
		...
		private function pageList(){
			...
			$linkPage.="<label class='thispage'>{$this->page}</label>";			
